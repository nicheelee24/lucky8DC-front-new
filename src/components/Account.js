...
export const Account = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const url = process.env.REACT_APP_BACKEND + "/api/users/change-password";
  ...
  return (
    <div className="max-w-[1200px] m-auto w-full mt-[30px] px-4 md:px-0">
      <div className="justify-between items-center mb-4 px-2">
        <h1 className="text-2xl lg:text-lg md:text-lg sm::text-lg text-[var(--secondaryColor)] font-semibold text-center lg:text-left md:text-left sm:text-left">
          Profile
        </h1>
      ...
      <div className="overflow-x-auto relative sm:rounded-lg mt-4">
        <div className="flex flex-col md:flex-row w-full text-sm text-left gap-6 px-2">
          <div className="w-full md:w-1/2">
            <h3 className="text-center lg:text-left md:text-left sm:text-left text-lg text-white border-[var(--logoutBg)] border-b-[4px] mb-4 font-bold">
              Account Details
            </h3>

            <div className="lg:flex lg:gap-8 md:flex md:gap-8 sm:flex sm:gap-8">
              <div className="w-full lg:w-1/2 md:w-1/2 sm:w-1/2">
                <div className="sub-info-group mt-4 border-b border-[var(--logoutBg)]">
                  <span className="text-white">Login id</span>
                  <p className="p-2 text-white">{loginid}</p>
                </div>

                <div className="sub-info-group mt-4 border-b border-[var(--logoutBg)]">
                  <span className="text-white">telephone</span>
                  <p className="p-2 text-white">{telephone}</p>
                </div>

                <div className="sub-info-group mt-4 border-b border-[var(--logoutBg)]">
                  <span className="text-white">BBAN</span>
                  <p className="p-2 text-white">{bban}</p>
                </div>

                <div className="sub-info-group mt-4 border-b border-[var(--logoutBg)]">
                  <span className="text-white">BBN</span>
                  <p className="p-2 text-white">{bbn}</p>
                </div>

                <div className="sub-info-group mt-4 border-b border-[var(--logoutBg)]">
                  <span className="text-white">BBUN</span>
                  <p className="p-2 text-white">{bbun}</p>
                </div>
              </div>
              ...
              <div className="w-full lg:w-1/2 md:w-1/2 sm:w-1/2">
                <div className="sub-info-group mt-4 border-b border-[var(--logoutBg)]">
                  ...
                  <p className="p-2 text-white">{creditLimit}</p>
                </div>

                <div className="sub-info-group mt-4 border-b border-[var(--logoutBg)]">
                  <span className="text-white">remaining balance</span>
                  <p className="p-2 text-white">{balance.toFixed(2)}</p>
                </div>

                <div className="sub-info-group mt-4 border-b border-[var(--logoutBg)]">
                  <span className="text-white">win lose</span>
                  <p className="p-2 text-white">{winlose}</p>
                </div>

                <div className="sub-info-group mt-4 border-b border-[var(--logoutBg)]">
                  <span className="text-white">not finished yet</span>
                  <p className="p-2 text-white">{notFinishedYet}</p>
                </div>
                {/* 
          ...
          <div className="w-full md:w-1/2">
            <h3 className="text-center lg:text-left md:text-left sm:text-left text-lg text-white border-[var(--logoutBg)] border-b-[4px] mb-4 font-bold mt-4 lg:mt-0 md:mt-0">
              Password
            </h3>
            ...
            {error && <p className="text-white text-xs italic">{error}</p>}
