...
export const GameList = () => {
  ...
  return (
    <>
      ...
      <div className="flex game-list flex-wrap mt-2 grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-5 xxlg:grid-cols-5 2xl:grid-cols-6 xxlg:grid-cols-8 gap-3 lg:gap-4 md:gap-4 sm:gap-4 px-1">
        {items &&
              ...
              <div className="rounder">
                <div className="card cursor-pointer rounded-lg">
                  <div className="w-full overflow-hidden rounded-tr-xl rounded-tl-xl flex items-center bg-[var(--secondaryColor)]">
                    <LazyLoadImage
                      src={
                        process.env.REACT_APP_BACKEND + "/images/" + item.img
                      }
                      srcSet={`${
                        process.env.REACT_APP_BACKEND + "/images/" + item.img
                      } 300w, ${
                  ...
                  <div className="presentation p-1 md:p-2 justify-between flex flex-col lg:flex-row items-center text-center lg:text-start rounded-b-xl ">
                    <span className="w-full overflow-hidden text-xl md:text-[.875rem] text-black font-bold whitespace-nowrap md:w-[50%] truncate">
                      {item.gameName}
                    </span>
                    <span className="text-2xl md:text-[.875rem] text-black font-bold  whitespace-nowrap truncate">
                      {item.platform}
                    </span>
                  </div>
                </div>
